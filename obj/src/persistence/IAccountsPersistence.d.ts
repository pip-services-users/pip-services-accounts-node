...
export interface IAccountsPersistence extends IGetter<AccountV1, string>, IWriter<AccountV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: AccountV1) => void): void;
    ...
    create(correlationId: string, user: AccountV1, callback: (err: any, item: AccountV1) => void): void;
    update(correlationId: string, user: AccountV1, callback: (err: any, item: AccountV1) => void): void;
    deleteById(correlationId: string, userId: string, callback: (err: any, item: AccountV1) => void): void;
}
