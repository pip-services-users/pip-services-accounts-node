...
const AccountV1GrpcConverter_1 = require("./AccountV1GrpcConverter");
class AccountsGrpcServiceV1 extends pip_services3_grpc_node_1.GrpcService {
    ...
    getAccounts(call, callback) {
        ...
        this._controller.getAccounts(correlationId, filter, paging, (err, result) => {
            let error = AccountV1GrpcConverter_1.AccountV1GrpcConverter.fromError(err);
            let page = err == null ? AccountV1GrpcConverter_1.AccountV1GrpcConverter.fromAccountPage(result) : null;
    ...
    getAccountById(call, callback) {
        ...
        this._controller.getAccountById(correlationId, accountId, (err, result) => {
            ...
            let account = err == null ? AccountV1GrpcConverter_1.AccountV1GrpcConverter.fromAccount(result) : null;
    ...
    createAccount(call, callback) {
        let correlationId = call.request.getCorrelationId();
        let account = AccountV1GrpcConverter_1.AccountV1GrpcConverter.toAccount(call.request.getAccount());
