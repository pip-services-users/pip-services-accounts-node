...
class AccountsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
AccountsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-Accounts", "factory", "default", "default", "1.0");
AccountsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-accounts", "persistence", "memory", "*", "1.0");
AccountsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-accounts", "persistence", "file", "*", "1.0");
AccountsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-accounts", "persistence", "mongodb", "*", "1.0");
AccountsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-accounts", "controller", "default", "*", "1.0");
AccountsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-accounts", "service", "seneca", "*", "1.0");
AccountsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-accounts", "service", "http", "*", "1.0");
