# Configuration Guide <br/> Users Microservice

Users microservice configuration structure follows the 
...
Example to retrieve microservice configuration remote repository by key 'pip-services-users':
```javascript
{
    "config": {
        "type": "remote",
        ...
        "key": "pip-services-users" // Microservice config key
    } 
    ...
}
```
