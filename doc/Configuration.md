# Configuration Guide <br/> User Accounts Microservice

User accounts microservice configuration structure follows the 
...
- options
  - login\_as\_email: boolean - (optional) treats user login as email address
...
Example:
```yaml
- descriptor: "pip-services-accounts:service:seneca:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 3000
